        ...
        for i, det in enumerate(pred):
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if (current_time - last_spoken_time > 3) and (object_name != last_spoken_object):
                        engine.say(object_name)
                        engine.runAndWait()
                        last_spoken_time = current_time
                        last_spoken_object = object_name
                    # =======================================================

                    label = None if hide_labels else f"{object_name} {conf:.2f}"
